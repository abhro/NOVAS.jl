...
const RMASS = [
    328900.5614, 6023600.0, 408523.71, 332946.050895, 3098708.0, 1047.3486,
...
const xi0 = -0.016617 * ASEC2RAD
const eta0 = -0.0068192 * ASEC2RAD
const da0 = -0.0146 * ASEC2RAD

const frame_tie_rot = @SMatrix [
    1 - 0.5(da0^2 + xi0^2) -da0 xi0
